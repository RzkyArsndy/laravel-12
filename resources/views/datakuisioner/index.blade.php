                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-8">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <button type="button" class="btn btn-outline-secondary w-100 py-2" data-value="N" data-target="alergi">N</button>
                                        </div>
                                        <div class="col-6">
                                            <button type="button" class="btn btn-outline-secondary w-100 py-2" data-value="Y" data-target="alergi">Y</button>
                                        </div>
                                        <input type="hidden" id="alergi" name="alergi" value="N">
                                    </div>
                                </div>

                                <!-- Sebutkan Alergi Jika Ada -->
                                <div class="mb-4">
                                    <label for="detail_alergi" class="form-label">Sebutkan Alergi Jika Ada</label>
                                    <input type="text" class="form-control" id="detail_alergi" name="detail_alergi">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <button type="button" class="btn btn-outline-secondary w-100 py-2" data-value="N" data-target="cidera">N</button>
                                        </div>
                                        <div class="col-6">
                                            <button type="button" class="btn btn-outline-secondary w-100 py-2" data-value="Y" data-target="cidera">Y</button>
                                        </div>
                                        <input type="hidden" id="cidera" name="cidera" value="N">
                                    </div>
                                </div>
