                    ...
                    <div class="container-fluid py-4">
                        <div class="row justify-content-center">
                            <div class="col-md-8">
                                ...
                                @endif
                                <form action="{{ route('mata.store') }}" method="POST">
                                    @csrf
                                    <form>
                                        <!-- Nama Lengkap -->
                                        <div class="mb-4">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="hidden" id="ButaWarna" name="ButaWarna" value=""
                                                    required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="hidden" id="RujukFasyankesMata" name="RujukFasyankesMata"
                                                    value="" required>
                                            </div>
                                        </div>
                                        ...
                                        <!-- Keterangan Rujukan -->
                                        <div class="mb-4">
                                            <label for="keteranganRujukanMata" class="form-label">Jika Iya Tuliskan
                                                Keterangan Rujukan Untuk Fasyankes<span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="keteranganRujukanMata"
                                                name="keteranganRujukanMata" required>
                                        </div>
